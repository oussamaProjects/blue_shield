<template>
  <div>
    <button
      ...
      :style="buttonStyle"
      data-toggle="modal"
      data-target="#appointmentCreateModal"
    >
          ...
          <div class="modal-body">
            <div class="row">
              <div class="form-group col-xs-12">
                <label for="title" class="col-sm-1 thin-weight control-label">{{
                  trans("Title")
                }}</label>
              ...
              <div class="form-group col-xs-12">
                <label
                  for="user-select"
                  class="col-sm-1 thin-weight control-label"
                  >{{ trans("User") }}</label
                >
                <div class="form-group col-sm-6">
                  <select
              ...
              <div class="form-inline col-xs-12">
                ...
                <div class="form-group col-sm-4">
                  <input
                    ...
                    name="start_date"
                    class="form-control"
                    v-model="newAppointment.start_date"
                  />
                </div>
              ...
              <div class="form-inline col-xs-12">
                ...
                <div class="form-group col-sm-4">
                  <input
                    ...
                    name="end_date"
                    class="form-control"
                    v-model="newAppointment.end_date"
                  />
                </div>
                <div class="form-group col-sm-3">
                  <input
              ...
              <div class="form-inline col-xs-12">
                <label for="color" class="col-sm-1 thin-weight control-label">{{
                  trans("Color")
                }}</label>
                ...
                <div class="form-group col-sm-4">
                  <select
                    ...
                    id="color"
                    class="form-control"
                    v-model="newAppointment.color"
                    :style="{ 'background-color': this.newAppointment.color }"
            ...
            <div
              ...
              v-for="error in newAppointmentErrors"
            >
              {{ error[0] }}
            </div>
            ...
            <div
              ...
              v-for="warning in timeAndDateWarnings"
            >
              {{ trans(warning[0]) }}
            </div>
          </div>
...
export default {
  props: {
    ...
    buttonStyle: {
      ...
      required: false,
      default:
        "font-size:20px; color: #fff; background-color: #536be2; margin-right:3em; margin-left:2em; border-radius:10%;",
    },
  },
  data() {
    return {
  ...
  created() {
    this.dateFormatsLoaded = axios.get("/settings/date-formats").then((res) => {
      ...
      this.newAppointment.start_date = moment().format(
        res.data.carbon_date_with_text.toUpperCase()
      );
      this.newAppointment.end_time = moment()
        .add(1, "hour")
        .format(res.data.momentjs_time);
      this.newAppointment.end_date = moment().format(
        res.data.carbon_date_with_text.toUpperCase()
      );
    });
  ...
  async mounted() {
    ...
    $("#start_date").pickadate({
      ...
      closeOnClear: false,
      onSet: (context) =>
        this.updateNewAppointmentDate(
          "start_date",
          moment(context.select).format(
            this.dateFormats.carbon_date_with_text.toUpperCase()
          )
        ),
    });
    $("#start_time").pickatime({
      ...
      hiddenName: true,
      onSet: (context) =>
        this.updateNewAppointmentTime(
          "start_time",
          moment.duration(context.select, "seconds")
        ),
    });
    $("#end_date").pickadate({
      hiddenName: true,
  ...
  methods: {
    ...
    validateTimeAndDate() {
      let start = moment(
        this.newAppointment.start_date +
          " " +
          this.newAppointment.start_time +
          ":00",
        this.dateFormats.carbon_date_with_text.toUpperCase() +
          " " +
          this.dateFormats.momentjs_time
      );
      let end = moment(
        this.newAppointment.end_date +
          " " +
          this.newAppointment.end_time +
          ":00",
        this.dateFormats.carbon_date_with_text.toUpperCase() +
          " " +
          this.dateFormats.momentjs_time
      ...
      if (start.isSameOrAfter(end)) {
        this.timeAndDateWarnings = {
          warnings: ["Not possible to set end before start"],
        };
        this.newAppointment.end_time = start
          .add(1, "hour")
          .format(this.dateFormats.momentjs_time);
      }
    ...
    createNewAppointment() {
      ...
      appointmentPost.start_date = moment(
        this.newAppointment.start_date,
        this.dateFormats.carbon_date_with_text.toUpperCase()
      ).format("YYYY/MM/DD");
      appointmentPost.end_date = moment(
        this.newAppointment.end_date,
        this.dateFormats.carbon_date_with_text.toUpperCase()
      ).format("YYYY/MM/DD");
    ...
    setDefaultNewAppointment() {
      ...
      this.newAppointment.start_time = moment().format(
        this.dateFormats.momentjs_time
      );
      this.newAppointment.start_date = moment().format(
        this.dateFormats.carbon_date_with_text.toUpperCase()
