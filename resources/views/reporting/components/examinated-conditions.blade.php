<div class="kt-portlet" id="examcond">
    ...
    <div class="kt-portlet__body">
        <div class="form-group row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                ...
                <select id='type' class="form-control kt_selectpicker" data-live-search="true" name="witnss">
                    ...
                    <option data-subtext="" value="AFNOR">AFNOR</option>
                    <option data-subtext="" value="Berthold">Berthold</option>
                    <option data-subtext="" value="AMSE">AMSE</option>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-6 col-md-12 col-sm-12">
                <div class="row align-items-center">
                    <div class="col-4">
                        <input type="text" class="form-control" required="required" id="kt_nouislider_1_input"
                            name="magnitdelay" placeholder="Quantity">
                    </div>
                    <div class="col-8">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <select id="revn" class="form-control kt_selectpicker" name="revealer">
                    ...
                    <option value="BABCCO" selected>BABCCO</option>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="kt-radio-inline">
                    <label class="kt-radio">
                        <input type="radio" value="Natural" checked name="lightu"> Natural Light <span></span>
                    </label>
                    <label class="kt-radio">
                        <input type="radio" value="Black" name="lightu"> Black Light<span></span>
                    </label>
                </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-4 col-md-9 col-sm-12">
                <input id="kt_touchspin_4" type="text" required="required"
                    class="form-control bootstrap-touchspin-vertical-btn" value="300" name="lightt" placeholder="40"
                    type="text">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-4 col-md-9 col-sm-12">
                <input id="kt_touchspin_4" type="text" required="required"
                    class="form-control bootstrap-touchspin-vertical-btn" value="700" name="brightt" placeholder="40"
                    type="text">
            </div>
        </div>
