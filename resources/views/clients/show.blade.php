            ...
            <div class="tablet">
                <div class="tablet__head">
                    <span class="tablet__head-label">
                        ...
                        <span>
                            <create-appointment v-on:created-appointment="reload()"
                            ...
                            <li style="list-style: none;">
                                <p>{{ $recentAppointment->title }} <br>
                                    <span style="font-size:10px;">
                                        {{ $recentAppointment->start_at->format(carbonFullDateWithText()) }} -
                                        {{ $recentAppointment->end_at->format(carbonFullDateWithText()) }}
